...
#[ORM\Entity(repositoryClass: StockMouvementVetementRepository::class)]
class StockMouvementVetement
{
    ...
    private ?StockVetement $article = null;
    ...
    public function getArticle(): ?StockVetement
    {
        return $this->article;
    }

    public function setArticle(?StockVetement $article): static
    {
