...
#[ORM\Entity(repositoryClass: StockMouvementVolantRepository::class)]
class StockMouvementVolant
{
    ...
    private ?StockVolant $article = null;
    ...
    public function getArticle(): ?StockVolant
    {
        return $this->article;
    }

    public function setArticle(?StockVolant $article): static
    {
